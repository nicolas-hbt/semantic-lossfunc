...
def sem_neg_files(train2id, neg_nb):
    ...
    if not isinstance(train2id, 'numpy.ndarray'):
...
if neg_sem > 150:
    if neg_sem <= 300:
        ...
        with open(dataset + 'pickle/sem_hr_' + str(neg_sem) + '_1.pkl', 'wb') as f:
            pickle.dump(sem_hr_1, f)
        with open(dataset + 'pickle/sem_tr_' + str(neg_sem) + '_1.pkl', 'wb') as f:
            pickle.dump(sem_tr_1, f)
        with open(dataset + 'pickle/sem_hr_' + str(neg_sem) + '_2.pkl', 'wb') as f:
            pickle.dump(sem_hr_2, f)
        with open(dataset + 'pickle/sem_tr_' + str(neg_sem) + '_2.pkl', 'wb') as f:
        ...
        with open(dataset + 'pickle/sem_tr_' + str(neg_sem) + '_2.pkl', 'wb') as f:
            pickle.dump(sem_tr_2, f)
        with open(dataset + 'pickle/sem_hr_' + str(neg_sem) + '_3.pkl', 'wb') as f:
            pickle.dump(sem_hr_3, f)
        with open(dataset + 'pickle/sem_tr_' + str(neg_sem) + '_3.pkl', 'wb') as f:
            pickle.dump(sem_tr_3, f)
else:
    sem_hr_, sem_tr_ = sem_neg_files(train2id, neg_sem)
    with open(dataset + 'pickle/sem_hr_' + str(neg_sem) + '.pkl', 'wb') as f:
        pickle.dump(sem_hr_, f)
    with open(dataset + 'pickle/sem_tr_' + str(neg_sem) + '.pkl', 'wb') as f:
        pickle.dump(sem_tr_, f)

print('dumb negatives.')
neg_dumb = 500
dumb_hr_, dumb_tr_ = dumb_neg_files(train2id, neg_dumb)
with open(dataset + 'pickle/dumb_hr_' + str(neg_dumb) + '.pkl', 'wb') as f:
    pickle.dump(dumb_hr_, f)
with open(dataset + 'pickle/dumb_tr_' + str(neg_dumb) + '.pkl', 'wb') as f:
