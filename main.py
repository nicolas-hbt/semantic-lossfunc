...
if __name__ == '__main__':
    ...
    if args.pipeline == 'both' or args.pipeline == 'test':
        ...
        for epoch in epochs2test:
            ...
            try:
                model_path = directory + args.loss_strategy + "__dim=" + str(args.dim) + "_loss=" + str(args.lossfunc) + "_lr=" + str(args.lr) + "_reg=" + str(args.reg) + "_neg=" + str(args.neg_ratio) + "_bs=" + str(
                    args.batch_size) + "_gamma1=" + str(args.gamma1) + "_gamma2=" + str(args.gamma2) + "_labelsem=" + str(args.labelsem) + "_alpha=" + str(args.alpha) + "__epoch=" + str(epoch) + ".pt"
            except FileNotFoundError:
                model_path = directory + args.loss_strategy + "__dim=" + str(args.dim) + "_lr=" + str(args.lr) + "_neg=" + str(args.neg_ratio) + "_bs=" + str(args.batch_size) + "_gamma1=" + str(
                    args.gamma1) + "_gamma2=" + str(args.gamma2) + "_labelsem=" + str(args.labelsem) + "_alpha=" + str(args.alpha) + "__epoch=" + str(epoch) + ".pt"
            ...
            if args.criterion_validation == 'mrr':
                if args.metrics == 'sem' or args.metrics == 'all':
                    ...
                    if args.sem == 'both':
                        if args.setting == 'both':
                            results[int(epoch)] = {"MRR": filt_mrr,
                                                   ...
                                                   "Ext_Sem@1": ext_CWA['sem1'],
                                                   "Ext_Sem@1_h": ext_CWA['sem1_h'],
                                                   "Ext_Sem@1_t": ext_CWA['sem1_t'],
                                                   "Ext_Sem@3": ext_CWA['sem3'],
                                                   "Ext_Sem@3_h": ext_CWA['sem3_h'],
                                                   "Ext_Sem@3_t": ext_CWA['sem3_t'],
                                                   "Ext_Sem@5": ext_CWA['sem5'],
                                                   "Ext_Sem@5_h": ext_CWA['sem5_h'],
                                                   "Ext_Sem@5_t": ext_CWA['sem5_t'],
                                                   "Ext_Sem@10": ext_CWA['sem10'],
                                                   "Ext_Sem@10_h": ext_CWA['sem10_h'],
                                                   "Ext_Sem@10_t": ext_CWA['sem10_t']}
                            ...
                            results[int(epoch)] = {"MRR": filt_mrr,
                                                   ...
                                                   "CWA_Sem@10_h": schema_CWA['sem10_h'],
                                                   "CWA_Sem@10_t": schema_CWA['sem10_t'],
                                                   "WUP_Sem@1": schema_WUP['sem1'],
                                                   "WUP_Sem@1_h": schema_WUP['sem1_h'],
                                                   "WUP_Sem@1_t": schema_WUP['sem1_t'],
                                                   "WUP_Sem@3": schema_WUP['sem3'],
                                                   "WUP_Sem@3_h": schema_WUP['sem3_h'],
                                                   "WUP_Sem@3_t": schema_WUP['sem3_t'],
                                                   "WUP_Sem@5": schema_WUP['sem5'],
                                                   "WUP_Sem@5_h": schema_WUP['sem5_h'],
                                                   "WUP_Sem@5_t": schema_WUP['sem5_t'],
                                                   "WUP_Sem@10": schema_WUP['sem10'],
                                                   "WUP_Sem@10_h": schema_WUP['sem10_h'],
                                                   "WUP_Sem@10_t": schema_WUP['sem10_t'],
                                                   "Ext_Sem@1": ext_CWA['sem1'],
                                                   "Ext_Sem@1_h": ext_CWA['sem1_h'],
                                                   "Ext_Sem@1_t": ext_CWA['sem1_t'],
                                                   "Ext_Sem@3": ext_CWA['sem3'],
                    ...
                    df_valid.to_csv('results/' +
                                    ...
                                    str(args.alpha) +
                                    '.csv')
                    with open('results/' + dataset.name + "/" + args.model + '/' + args.sem + '-' + args.setting + '/' + '[' + date_today + ']' + args.model + '-valid_results-mrr_only-' + args.dataset + '-' + model + '-loss_str=' + args.loss_strategy + '-dim=' +
                              str(args.dim) + "-loss=" + str(args.lossfunc) + '-lr=' + str(args.lr) + "-reg=" + str(args.reg) + '-neg=' + str(args.neg_ratio) + '-bs=' + str(args.batch_size) +
                              "-gamma1=" + str(args.gamma1) + "-gamma2=" + str(args.gamma2) + "-labelsem=" + str(args.labelsem) + "-alpha=" + str(args.alpha) + '.json', 'w') as fp:
                        json.dump(results, fp)
        ...
        if args.metrics == 'sem' or args.metrics == 'all':
            ...
            df_test.to_csv('results/' +
                           ...
                           str(args.alpha) +
                           '.csv')
            with open('results/' + dataset.name + "/" + args.model + '/' + args.sem + '-' + args.setting + '/' + '[' + date_today + ']best-epoch_results-RANK-BASED-' + args.dataset + '-' + model + '-loss_str=' + args.loss_strategy + '-dim=' +
                      str(args.dim) + "-loss=" + str(args.lossfunc) + '-lr=' + str(args.lr) + "-reg=" + str(args.reg) + '-neg=' + str(args.neg_ratio) + '-bs=' + str(args.batch_size) +
                      "-gamma1=" + str(args.gamma1) + "-gamma2=" + str(args.gamma2) + "-labelsem=" + str(args.labelsem) + "-alpha=" + str(args.alpha) + '.json', 'w') as fp:
                json.dump(best_ep_results, fp)
