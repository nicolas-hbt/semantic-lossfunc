...
class Tester:
    def __init__(self, dataset, args, model_path, valid_or_test):
        ...
        self.lmbda = args.reg
        self.dir = "reindexed-datasets/" + self.dataset.name + "/"
    ...
    def calc_valid_mrr(self):
        ...
        if (self.sem == 'schema' or self.sem ==
            ...
            if True:
                ...
                schema_CWA_wp['sem1'] = (
                    ((schema_CWA_wp['sem1_h'] / sem_h_triples_CWA) + (
                        schema_CWA_wp['sem1_t'] / sem_t_triples_CWA)) / 2) * 100
                schema_CWA_wp['sem3'] = (
                    ((schema_CWA_wp['sem3_h'] / sem_h_triples_CWA) + (
                        schema_CWA_wp['sem3_t'] / sem_t_triples_CWA)) / 2) * 100
                schema_CWA_wp['sem5'] = (
                    ((schema_CWA_wp['sem5_h'] / sem_h_triples_CWA) + (
                        schema_CWA_wp['sem5_t'] / sem_t_triples_CWA)) / 2) * 100
                schema_CWA_wp['sem10'] = (
                    ((schema_CWA_wp['sem10_h'] / sem_h_triples_CWA) + (
                        schema_CWA_wp['sem10_t'] / sem_t_triples_CWA)) / 2) * 100
                schema_CWA_wp['sem1_h'], schema_CWA_wp['sem1_t'] = (
                    schema_CWA_wp['sem1_h'] / sem_h_triples_CWA) * 100, (schema_CWA_wp['sem1_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem3_h'], schema_CWA_wp['sem3_t'] = (
                    schema_CWA_wp['sem3_h'] / sem_h_triples_CWA) * 100, (schema_CWA_wp['sem3_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem5_h'], schema_CWA_wp['sem5_t'] = (
                    schema_CWA_wp['sem5_h'] / sem_h_triples_CWA) * 100, (schema_CWA_wp['sem5_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem10_h'], schema_CWA_wp['sem10_t'] = (
                    schema_CWA_wp['sem10_h'] / sem_h_triples_CWA) * 100, (schema_CWA_wp['sem10_t'] / sem_t_triples_CWA) * 100
            else:
                schema_CWA['sem1'] = (
                    ((schema_CWA['sem1_t'] / sem_t_triples_CWA))) * 100
                schema_CWA['sem3'] = (
                    ((schema_CWA['sem3_t'] / sem_t_triples_CWA))) * 100
                schema_CWA['sem5'] = (
                    ((schema_CWA['sem5_t'] / sem_t_triples_CWA))) * 100
                schema_CWA['sem10'] = (
                    ((schema_CWA['sem10_t'] / sem_t_triples_CWA))) * 100
                schema_CWA['sem1_h'], schema_CWA['sem1_t'] = 0.0, (
                    schema_CWA['sem1_t'] / sem_t_triples_CWA) * 100
                schema_CWA['sem3_h'], schema_CWA['sem3_t'] = 0.0, (
                    schema_CWA['sem3_t'] / sem_t_triples_CWA) * 100
                schema_CWA['sem5_h'], schema_CWA['sem5_t'] = 0.0, (
                    schema_CWA['sem5_t'] / sem_t_triples_CWA) * 100
                schema_CWA['sem10_h'], schema_CWA['sem10_t'] = 0.0, (
                    schema_CWA['sem10_t'] / sem_t_triples_CWA) * 100

                schema_CWA_wp['sem1'] = (
                    ((schema_CWA_wp['sem1_t'] / sem_t_triples_CWA))) * 100
                schema_CWA_wp['sem3'] = (
                    ((schema_CWA_wp['sem3_t'] / sem_t_triples_CWA))) * 100
                schema_CWA_wp['sem5'] = (
                    ((schema_CWA_wp['sem5_t'] / sem_t_triples_CWA))) * 100
                schema_CWA_wp['sem10'] = (
                    ((schema_CWA_wp['sem10_t'] / sem_t_triples_CWA))) * 100
                schema_CWA_wp['sem1_h'], schema_CWA_wp['sem1_t'] = 0.0, (
                    schema_CWA_wp['sem1_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem3_h'], schema_CWA_wp['sem3_t'] = 0.0, (
                    schema_CWA_wp['sem3_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem5_h'], schema_CWA_wp['sem5_t'] = 0.0, (
                    schema_CWA_wp['sem5_t'] / sem_t_triples_CWA) * 100
                schema_CWA_wp['sem10_h'], schema_CWA_wp['sem10_t'] = 0.0, (
                    schema_CWA_wp['sem10_t'] / sem_t_triples_CWA) * 100
        ...
        if (self.sem == 'extensional' or self.sem ==
            ...
            if True:
                ...
                ext_CWA['sem5'] = (((ext_CWA['sem5_h'] / sem_h_triples_ext) +
                                   (ext_CWA['sem5_t'] / sem_t_triples_ext)) / 2) * 100
                ext_CWA['sem10'] = (((ext_CWA['sem10_h'] / sem_h_triples_ext) +
                                    (ext_CWA['sem10_t'] / sem_t_triples_ext)) / 2) * 100
                ext_CWA['sem1_h'], ext_CWA['sem1_t'] = (
                    ext_CWA['sem1_h'] / sem_h_triples_ext) * 100, (ext_CWA['sem1_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem3_h'], ext_CWA['sem3_t'] = (
                    ext_CWA['sem3_h'] / sem_h_triples_ext) * 100, (ext_CWA['sem3_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem5_h'], ext_CWA['sem5_t'] = (
                    ext_CWA['sem5_h'] / sem_h_triples_ext) * 100, (ext_CWA['sem5_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem10_h'], ext_CWA['sem10_t'] = (
                    ext_CWA['sem10_h'] / sem_h_triples_ext) * 100, (ext_CWA['sem10_t'] / sem_t_triples_ext) * 100
            else:
                ext_CWA['sem1'] = (
                    ((ext_CWA['sem1_t'] / sem_t_triples_ext))) * 100
                ext_CWA['sem3'] = (
                    ((ext_CWA['sem3_t'] / sem_t_triples_ext))) * 100
                ext_CWA['sem5'] = (
                    ((ext_CWA['sem5_t'] / sem_t_triples_ext))) * 100
                ext_CWA['sem10'] = (
                    ((ext_CWA['sem10_t'] / sem_t_triples_ext))) * 100
                ext_CWA['sem1_h'], ext_CWA['sem1_t'] = 0.0, (
                    ext_CWA['sem1_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem3_h'], ext_CWA['sem3_t'] = 0.0, (
                    ext_CWA['sem3_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem5_h'], ext_CWA['sem5_t'] = 0.0, (
                    ext_CWA['sem5_t'] / sem_t_triples_ext) * 100
                ext_CWA['sem10_h'], ext_CWA['sem10_t'] = 0.0, (
                    ext_CWA['sem10_t'] / sem_t_triples_ext) * 100
            logger.info('[Extensional] Sem@{}: {} | Sem@{}: {} | Sem@{}: {}'.format(1,
                                                                                    (eval("ext_CWA['sem" + str(1) + "']")),
                                                                                    3,
                                                                                    (eval("ext_CWA['sem" + str(3) + "']")),
                                                                                    10,
                                                                                    (eval("ext_CWA['sem" + str(10) + "']"))))
    ...
    def test(self):
        ...
        if self.sem == 'extensional' or self.sem == 'both':
            print('sem_t_triples_extensional: ', sem_t_triples_ext)
            print('sem_h_triples_extensional: ', sem_h_triples_ext)
            ext_CWA['sem1'] = (((ext_CWA['sem1_h'] / sem_h_triples_ext) +
                               (ext_CWA['sem1_t'] / sem_t_triples_ext)) / 2) * 100
            ext_CWA['sem3'] = (((ext_CWA['sem3_h'] / sem_h_triples_ext) +
                               (ext_CWA['sem3_t'] / sem_t_triples_ext)) / 2) * 100
            ...
            ext_CWA['sem10_h'], ext_CWA['sem10_t'] = (
                ext_CWA['sem10_h'] / sem_h_triples_ext) * 100, (ext_CWA['sem10_t'] / sem_t_triples_ext) * 100
            for k in [1, 3, 5, 10]:
                logger.info('[Extensional] Sem@{}: {}'.format(k,
                            (eval("ext_CWA['sem" + str(k) + "']"))))
